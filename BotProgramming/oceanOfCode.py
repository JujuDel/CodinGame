...
if __name__ == '__main__':
    print("You have enoug info to make your own BOT now \U0001F609", file=sys.stderr)
    print("http://www.someecards.com/usercards/nsviewcard/MjAxMi04ZWYxNjNmNTI5ODZiMjk0/", file=sys.stderr)
